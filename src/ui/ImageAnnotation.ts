...
export class ImageAnnotationModal extends Modal {
	...
	private createColorSwatches() {
		...
		grayScaleRow.createSpan('image-converter-annotation-tool-row-label').setText(t("LABEL_ANNOTATION_GRAYSCALE") + ":");
		...
		paletteRow.createSpan('image-converter-annotation-tool-row-label').setText(t("LABEL_ANNOTATION_PALETTE") + ":");
		...
		dominantRow.createSpan('image-converter-annotation-tool-row-label').setText(t("LABEL_ANNOTATION_DOMINANT") + ":");
	...
	private createTextBackgroundControls(container: HTMLElement) {
		...
		textBgContainer.createDiv('control-label').setText(t("LABEL_ANNOTATION_TEXT_BG") + ":");
		...
		new ButtonComponent(controlsContainer)
			.setTooltip(t("TOOLTIP_ANNOTATION_TRANSPARENT"))
			.setIcon('eraser')
			.onClick(() => {
		...
		new ButtonComponent(controlsContainer)
			.setTooltip(t("TOOLTIP_ANNOTATION_WHITE_SEMI"))
			.setIcon('square')
			.onClick(() => {
		...
		new ButtonComponent(controlsContainer)
			.setTooltip(t("TOOLTIP_ANNOTATION_BLACK_SEMI"))
			.setIcon('square')
			.onClick(() => {
	...
	private createPresetButtons(container: Element) {
		...
		for (let i = 0; i < 3; i++) {
			...
			presetButton.setAttribute('title', t("TOOLTIP_ANNOTATION_SAVE_LOAD_PRESET"));
		}
	...
	private setupToolbar(container: HTMLElement) {
		...
		this.drawButton = new ButtonComponent(drawingToolsColumn)
			.setTooltip(t("TOOLTIP_ANNOTATION_PENCIL"))
			.setIcon('pencil')
			.onClick(() => {
				this.toggleDrawingMode(this.drawButton);
			});
		...
		const arrowButton = new ButtonComponent(drawingToolsColumn)
			.setTooltip(t("TOOLTIP_ANNOTATION_ARROW"))
			.setIcon('arrow-right')
			.onClick(() => {
		...
		this.textButton = new ButtonComponent(drawingToolsColumn)
			.setTooltip(t("TOOLTIP_ANNOTATION_TEXT"))
			.setIcon('type')
			.onClick(() => {
				this.toggleTextMode();
			});
		...
		layerControls.createDiv('control-label').setText(t("LABEL_ANNOTATION_LAYER") + ":");
		...
		new ButtonComponent(layerButtonContainer)
			.setTooltip(t("TOOLTIP_ANNOTATION_FRONT"))
			.setIcon('arrow-up-to-line')
			.onClick(() => this.bringToFront());

		// Bring forward buttoncreateBackgroundControls
		new ButtonComponent(layerButtonContainer)
			.setTooltip(t("TOOLTIP_ANNOTATION_FORWARD"))
			.setIcon('arrow-up')
			.onClick(() => this.bringForward());

		// Send backward button
		new ButtonComponent(layerButtonContainer)
			.setTooltip(t("TOOLTIP_ANNOTATION_BACKWARD"))
			.setIcon('arrow-down')
			.onClick(() => this.sendBackward());

		// Send to back button
		new ButtonComponent(layerButtonContainer)
			.setTooltip(t("TOOLTIP_ANNOTATION_BACK"))
		...
		new ButtonComponent(utilityGroup)
			.setTooltip(t("TOOLTIP_ANNOTATION_CLEAR"))
			.setIcon('trash')
	...
	private createSizeButtons(container: HTMLElement) {
		...
		sizeLabel.setText(t("LABEL_ANNOTATION_SIZE") + ":");
	...
	private createOpacityButtons(container: HTMLElement) {
		...
		opacityLabel.setText(t("LABEL_ANNOTATION_OPACITY") + ":");
	...
	private createBlendModeButtons(container: HTMLElement) {
		...
		blendModeLabel.setText(t("LABEL_ANNOTATION_BLEND") + ":");
		...
		const getFriendlyName = (mode: BlendMode): string => {
			switch (mode) {
				case 'source-over': return t("BLEND_NORMAL");
				case 'multiply': return t("BLEND_MULTIPLY");
				case 'screen': return t("BLEND_SCREEN");
				case 'overlay': return t("BLEND_OVERLAY");
				case 'darken': return t("BLEND_DARKEN");
				case 'lighten': return t("BLEND_LIGHTEN");
				case 'color-dodge': return t("BLEND_COLOR_DODGE");
				case 'color-burn': return t("BLEND_COLOR_BURN");
				case 'hard-light': return t("BLEND_HARD_LIGHT");
				case 'soft-light': return t("BLEND_SOFT_LIGHT");
				case 'difference': return t("BLEND_DIFFERENCE");
				case 'exclusion': return t("BLEND_EXCLUSION");
				default: return mode;
			}
		};
	...
	private createBackgroundControls(container: HTMLElement) {
		...
		const bgButton = new ButtonComponent(container)
			.setTooltip(t("LABEL_ANNOTATION_BACKGROUND"))
